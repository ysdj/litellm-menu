...
SPECS = [
    ...
    {"key": "LITELLM_MENU_DEPLOYMENT_COOLDOWN_FAILURES", "category": "Fallback", "label": "Cooldown failures", "unit": "failures", "kind": "int", "default": "2", "minimum": 0, "maximum": 20, "help": "Consecutive deployment/provider failures before a deployment is temporarily skipped. 0 disables deployment cooldown."},
    {"key": "LITELLM_MENU_DEPLOYMENT_COOLDOWN_SECONDS", "category": "Fallback", "label": "Cooldown duration", "unit": "seconds", "kind": "float", "default": "300", "minimum": 0, "maximum": 86400, "help": "How long a deployment is globally skipped after reaching the cooldown failure threshold. 0 disables deployment cooldown."},
