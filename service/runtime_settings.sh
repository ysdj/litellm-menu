...
SPECS = [
    ...
    {"key": "LITELLM_MENU_STALL_TIMEOUT_SECONDS", "category": "Timeouts", "label": "Stall timeout", "unit": "seconds", "kind": "float", "default": "120", "minimum": 0, "maximum": 3600, "help": "No stream event within this window is treated as a stalled stream. Structured Codex compaction gets a 300-second first-event window; later events use this setting."},
    {"key": "LITELLM_MENU_RECOVERY_MAX_SECONDS", "category": "Timeouts", "label": "Recovery max", "unit": "seconds", "kind": "float", "default": "43200", "minimum": 0, "maximum": 86400, "help": "Maximum route recovery polling time. Interactive Codex turns are capped at 300 seconds, and structured compaction never enters recovery polling. 0 disables polling."},
